...
describe("EndSimulationModal", () => {
  ...
  it("shows win streak badge when currentStreak >= 2", () => {
    render(
      <EndSimulationModal
        realDateRange="01/01/2020 → 01/06/2020"
        elapsedTime="00:05:03"
    ...
    expect(screen.getByText("4 Win Streak!")).toBeInTheDocument();
    expect(screen.getByRole("img", { name: "fire" })).toBeInTheDocument();
  });

  it("does not show streak badge when currentStreak is 1 (below threshold)", () => {
    render(
      <EndSimulationModal
        realDateRange="01/01/2020 → 01/06/2020"
        elapsedTime="00:05:03"
    ...
    expect(screen.queryByText(/Win Streak!/i)).not.toBeInTheDocument();
  });

  it("does not show streak badge when currentStreak is 0", () => {
    render(
      <EndSimulationModal
        realDateRange="01/01/2020 → 01/06/2020"
        elapsedTime="00:05:03"
  ...
  it("streak badge shows exact count", () => {
    render(
      <EndSimulationModal
        realDateRange="01/01/2020 → 01/06/2020"
        elapsedTime="00:05:03"
