              ...
              <div className="flex items-center gap-2">
                ...
                <div className="relative flex-1">
                  <input
                    ...
                    className="w-full px-3 py-2 pr-16 rounded-lg bg-crypto-surface-elevated border border-crypto-border text-sm font-mono text-crypto-text placeholder:text-crypto-text-muted focus:outline-none focus:border-crypto-accent cursor-pointer"
                  />
                  {limitPrice && (
                    <button
                      onClick={() => setLimitPrice("")}
                      className="absolute right-8 top-1/2 -translate-y-1/2 p-0.5 rounded text-crypto-text-muted hover:text-crypto-short hover:bg-crypto-short-dim transition-all"
                    >
                      <X className="w-3 h-3" />
                    </button>
                  )}
